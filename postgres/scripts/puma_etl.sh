...
do
  ...
  if [ ! -f "$zip_file_path" ] ; then
    ...
    wget "http://www2.census.gov/geo/tiger/GENZ2016/shp/cb_2016_${code}_puma10_500k.zip" --header 'Connection: keep-alive' --header 'User-Agent: Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/70.0.3538.77 Safari/537.36' -P /usr/src/puma/
  fi
